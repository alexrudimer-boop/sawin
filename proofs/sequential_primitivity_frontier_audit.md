...
The exhaustive size-3 corpus has no sequential-primitivity candidate, and the current size-4/affine pressure representatives are closed by explicit active-factor or sequential rack certificates. The next falsifiable search frontier starts at larger nonterminal tables, for example size 5 or structured affine-linear families beyond the hidden cyclic gauge.
