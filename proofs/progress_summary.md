...
show representative seed visibility in an admissible fixed
Green/Schutzenberger/atom readout, leaving only strand-continuing
transport-rack gauge after propagation.
...
- `python -m unittest discover -s tests` passed with 321 tests;
