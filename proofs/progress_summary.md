...
- `python -m unittest discover -s tests` passed with 359 tests;
...
- the proof log DOCX and reduction audit workbook were regenerated, and the
  workbook preview/OOXML marker checks included the routed-edge witness and
  unit-continuation rows;
