...
9. `proofs/artin_defect_longitudinalization_sieve.md`
10. `proofs/artin_detector_lift_criterion.md`
11. `proofs/atom_inner_detector_lift_rows.md`
12. `proofs/green_first_output_defect_criterion.md`
13. `proofs/green_defect_kernel_quotient_detection.md`
14. `proofs/green_defect_potential_coboundary.md`
15. `proofs/artin_defect_abelianization_barrier.md`
16. `proofs/green_defect_abelianization_split.md`
17. `proofs/abelian_longitude_image_criterion.md`
18. `proofs/green_balanced_defect_gauge_decomposition.md`
19. `proofs/terminal_gauge_longitudinalization_criterion.md`
20. `proofs/principal_gauge_extension_detector.md`
21. `proofs/transport_state_rackification_detector.md`
22. `proofs/continuation_congruence_descent_gate.md`
23. `proofs/elementary_continuation_closure.md`
24. `proofs/universal_continuation_derivation_certificate.md`
25. `proofs/product_readout_kernel_assembly.md`
26. `proofs/product_readout_descent_separation.md`
27. `proofs/readout_seed_saturation.md`
28. `proofs/local_minimal_seed_saturation_dichotomy.md`
29. `proofs/lost_edge_external_routing.md`
30. `proofs/routed_lost_edge_endpoint_witness.md`
31. `proofs/chart_transport_collapse.md`
32. `proofs/descent_separation_transport_rack_closure.md`
33. `proofs/unit_continuation_final_obstruction.md`
34. `proofs/unit_continuation_abelian_kernel_lift.md`
35. `proofs/sawin_proof_log.docx`
36. `tables/reduction_audit.xlsx`
37. The code and tests under `src/`, `tools/`, and `tests/`
