...
22. `proofs/chart_transport_collapse.md`
23. `proofs/descent_separation_transport_rack_closure.md`
24. `proofs/sawin_proof_log.docx`
25. `tables/reduction_audit.xlsx`
26. The code and tests under `src/`, `tools/`, and `tests/`
