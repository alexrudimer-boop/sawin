...
def build_report():
    scans = {
        ...
        "size_2_depth_3": scan_size(2, depth=3, morphism_limit=50000),
        "size_3_depth_3": scan_size(3, depth=3, morphism_limit=50000),
    }
    report = {
        "date": "2026-06-03",
        "scans": scans,
...
def render_markdown(report):
    lines = [
        ...
        "bijective YBE solutions of sizes `2` and `3`, at depths `2` and `3`,",
        "keeps only the",
        ...
        "the actual completed-context depth.",
        "",
        ...
        json.dumps(
            {
                ...
                "size_3_depth_3_unresolved": report["scans"]["size_3_depth_3"][
                    "unresolved_nonidentity_group_loop_solution_count"
                ],
            },
            sort_keys=True,
