...
const rows = [
  ...
  [
    "Chief-layer tail split",
    "Split minimal monolithic first-failure quotients into large-chief tails and abelian Frattini-depth tails.",
    "proofs/point_pushing_chief_layer_tail_split.md proves that nonabelian monoliths embed H in Aut(M), complemented abelian monoliths give H=M semidirect L with L<=Aut(M), and only abelian M<=Phi(H) can escape without |M|->infinity.",
    "Large chief or Frattini depth",
    "Rule out large chief factors and abelian Frattini-depth tails, or construct one for B.",
  ],
  [
    "Monolith type split",
  ...
  [
    "Transport residual abelianization bound",
    "Bound finite abelian quotients of abelian-visible transport residuals.",
    "proofs/point_pushing_transport_residual_abelianization_bound.md proves that E_ab is generated by ambient transported images of q, each of order dividing B_X, hence exp(E_ab)|B_X. point_pushing_centralizer_stem_multiplier_audit records residual abelianization exponent and prime support.",
    "Transport abelianization bounded",
    "Rule out bounded-prime bounded-exponent transport residual rank/orbit tails, or construct one for B.",
  ],
  [
